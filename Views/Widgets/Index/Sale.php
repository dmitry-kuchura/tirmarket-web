                        ...
                        <div class="catalog-slider__slide">
                            <div class="item-card">
                                ...
                                <div class="item-card__labels">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($obj->top == 1): ?>
                                        <div class="label label--purple"><span><?php echo __('популярный'); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($obj->new == 1): ?>
                                ...
                                <div class="_flex _mb-3 _justify-between">
                                    <div class="_col-auto">
                                        <?php if ($obj->sale == 1): ?>
                                            <div class="item-card__price item-card__price--past"><?php echo Price::getCurrentPrice($obj->cost_old); ?>
                                                грн.
                                            </div>
                                        <?php endif; ?>
                                        <div class="item-card__price"><?php echo Price::getCurrentPrice($obj->cost); ?>
                                        </div>
                                    </div>
                                    <div class="_col-auto">
                                ...
                                <div class="_flex _justify-between _items-center _grid-space-3 _flex-nowrap">
                                    <div class="_col-auto">
                                        <a href="#"
                                           class="icon-button favorite-button <?php echo in_array($obj->id, $favorites) ? 'in-favorite-now' : ''; ?>"
                            ...
                            <div class="item-card">
                                ...
                                <div class="_flex _mb-3 _justify-between">
                                    <div class="_col-auto">
                                        ...
                                        <?php endif; ?>
                                        <div class="item-card__price"><?php echo number_format($obj->cost); ?>грн.
                                        </div>
                                    </div>
                                    <div class="_col-auto">
                                        <?php if ($obj->available == 1): ?>
