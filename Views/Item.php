        ...
        <div class="page-size">
            ...
            <div class="_flex _grid-space-3">
                <div class="_col-12 _lg-col-5 _xl-col-4 _flex-grow-0 _mb-3">
                    <div class="product-gallery">
                        ...
                        <div class="product-image" data-slider="product">
                            <div class="product-image__item"><img src="pic/product.jpg" alt=""></div>
                            <div class="product-image__item"><img src="pic/product.jpg" alt=""></div>
                            <div class="product-image__item"><img src="pic/product.jpg" alt=""></div>
                            <div class="product-image__item"><img src="pic/product.jpg" alt=""></div>
                            <div class="product-image__item"><img src="pic/product.jpg" alt=""></div>
                        ...
                        <div class="product-thumbs" data-slider="product-thumb">
                            <div class="product-thumbs__item"><img src="pic/product-thumb-1.jpg" alt=""></div>
                            <div class="product-thumbs__item"><img src="pic/product-thumb-2.jpg" alt=""></div>
                            <div class="product-thumbs__item"><img src="pic/product-thumb-1.jpg" alt=""></div>
                            <div class="product-thumbs__item"><img src="pic/product-thumb-1.jpg" alt=""></div>
                            <div class="product-thumbs__item"><img src="pic/product-thumb-1.jpg" alt=""></div>
                            <div class="product-thumbs__item"><img src="pic/product-thumb-1.jpg" alt=""></div>
                ...
                <div class="_col-12 _lg-col-7 _xl-col-5 _flex-grow-0 _flex-shrink-0 _mb-3">
                    <div class="title _mb-3">Моторное масло Liqui Moly MoS2 Leichtlauf SAE 15W-40 1 л (1932)</div>
                    <div class="product-meta _mb-4">
                        <div class="_flex">
                            <div class="_col-6">
                                <div class="product-exist product-exist--true">В наличии</div>
                            </div>
                            <div class="_col-6">
                                <div class="product-code">Артикул: 2152345-Р5223</div>
                            </div>
                        </div>
                        ...
                        <div class="_flex _items-center">
                            ...
                            <div class="_col-6"><a href="#" class="favorite-button"><i
                                            class="icon icon--sm icon--blue _mr-2">
                                        <svg>
                                            <use xlink:href="icons/icons.svg#star"></use>
                                        </svg>
                                    </i><span>В избранное</span></a></div>
                        </div>
                    </div>
                    <div class="product-handler">
                        <div class="_pl-3 _pr-3 _pt-3 _pb-2">
                            <div class="_flex _justify-between _grid-space-3 _items-end">
                                ...
                                <div class="_col-auto _mb-2">
                                    <div class="product-counter" data-counter data-binding="product"><input type="text"
                                                                                                            value="1"
                                                                                                            readonly="readonly"
                                                                                                            class="product-counter__field"
                                                                                                            data-counter-value>
                                ...
                                <div class="_col-auto _mb-2">
                                    <div class="_flex _flex-column"><a href="#" class="one-click-button _mb-2"
                                                                       data-mfp="popups/oneclick.php"
                                                                       data-param='{"id": "15546"}'><i
                                                    class="icon icon--sm icon--blue _mr-2">
                                                <svg>
                                                    <use xlink:href="icons/icons.svg#cursor"></use>
                                                </svg>
                                            </i><span>Купить в ОДИН КЛИК</span> </a><a href="#" class="button"
                                                                                       data-basket-trigger data-id="34"
                                                                                       data-binding="product"><span><i><svg><use
            ...
            <div class="_mb-5">
                ...
                <div data-tab-content="2" data-tab-ns="product">
                    <div class="wysiwyg"><p><b>Mobil Super</b> — масла премиум-класса. Они разработаны специально для
                            того, чтобы обеспечить отличную защиту двигателя и его надежную работу, что позволяет вам ездить
