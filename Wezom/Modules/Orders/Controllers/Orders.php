...
class Orders extends Base
{
    ...
    function before()
    {
        ...
        $this->delivery = CommonI18n::factory('delivery')->getRows(1, 'sort', 'ASC');
        $this->payment = CommonI18n::factory('payments')->getRows(1, 'sort', 'ASC');
    ...
    function editAction()
    {
        ...
        foreach ($this->payment as $obj) {
            $payment[$obj->id] = $obj->name;
        }

        $delivery = [];

        foreach ($this->delivery as $obj) {
