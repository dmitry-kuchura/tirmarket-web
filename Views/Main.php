        ...
        <div class="seo-section">
            <div class="page-size">
                ...
                <div class="_flex _grid-1 _md-grid-2 _grid-space-4">
                    <div class="wysiwyg _mb-4"><h2>Грузовики MAN</h2>
                        <p>Грузовики MAN (Maschinen-fabrik Augsburg-Nurnberg) – автомобили с мировым именем, заслуженно
                            ...
                            номинациях.</p>
                        <p>Обладателями одной из таких наград стали MAN грузовики TGL серии, они получили почетное
                            звание «Truck of the Year» («Грузовой автомобиль года»).</p>
                        <p>В продукции концерна MAN Group воплощаются самые передовые инженерные решения и технологии,
                            ...
                            имеют достаточно конкурентную цену на рынке.</p></div>
                    <div class="wysiwyg _mb-4"><h2>Обслуживание грузовиков MAN</h2>
                        <p>УКРРОСТЕХНО - это гарантийный и качественный сервис грузовиков МАН, современный сервисный
                            ...
                            отдыха.</p>
                        <p>Вы можете быть уверены в высоком качестве услуг нашего сервисного центра для грузовиков MAN,
                            ведь в штате компании УКРРОСТЕХНО работают только профессиональные специалисты прошедшие
                            специальное обучение по обслуживанию техники МАН.</p>
                        <p>«Официальный дилер МАН» и «Официальный сервисный центр МАН» позволяют мастерам сервиса иметь
                            в своем распоряжении передовые компьютерные средства диагностики автомобилей, доступ к базам
                            данных запчастей и технической документации грузовиков.</p></div>
                </div>
            </div>
        </div>
    </main>
