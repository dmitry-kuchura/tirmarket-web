...
use Wezom\Modules\Orders\Models\Delivery AS Model;

class Delivery extends Base
{

    public $tpl_folder = 'Orders/Delivery';
    public $page;
    public $limit;
    public $offset;
    ...
    {
        parent::before();
        $this->_seo['h1'] = __('Способы доставки');
        $this->_seo['title'] = __('Способы доставки');
        $this->setBreadcrumbs(__('Способы доставки'), 'wezom/' . Route::controller() . '/index');
