<div class="page-size _pt-5 _pb-5">
    <div class="_flex _justify-center _mb-4">
        <a href="#" class="tab-link is-active" data-tab-trigger="1" data-tab-ns="category">Акции</a>
        <a href="#" class="tab-link" data-tab-trigger="2" data-tab-ns="category">Популярные товары</a></div>
            ...
            <div data-slider="promo" class="catalog-slider">
                ...
                <div class="catalog-slider__slide">
                    <div class="item-card"><a href="/product.html" class="item-card__image"
                        ...
                        <a href="/product.html" class="item-card__title">Выключатель массы 24V VOLVO / MAN /
                            IVECO / DAF / MB / ICARUS</a>
                        <div class="item-card__code">Артикул: 2152345-Р5223</div>
                        <div class="_flex _mb-3 _justify-between">
                            <div class="_col-auto">
                                <div class="item-card__price item-card__price--past">1 530 грн.</div>
