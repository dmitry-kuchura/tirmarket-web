                                ...
                                <div class="clearFix">
                                    <div class="pull-left">
                                        <div class="pull-left">
                                            ...
                                            <div class="size11 nowrap">(<span
                                                        class="gray">URL:</span> <?php echo $obj->url; ?>)
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td width="45" valign="top" class="icon-column">
                                <?php if ($obj->parent_id == 1): ?>
                                    <?php echo __('Правая колонка'); ?>
                                    <i class="fa fa-align-right" aria-hidden="true"></i>
                                <?php else: ?>
                                    <?php echo __('Левая колонка'); ?>
