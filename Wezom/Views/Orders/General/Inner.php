    ...
    <div class="col-sm-6 col-md-4">
        <div class="statbox widget box box-shadow">
            <div class="widgetContent">
                ...
                <div class="value"><?php echo Price::getCurrencies($obj->currencies, $obj->amount); ?> <?php echo Price::getCurrency($obj->currencies) ?></div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-md-4">
...
<div class="rowSection column-2">
    <div class="col-md-7">
        <div class="widget">
            <div class="widgetHeader">
                <div class="widgetTitle"><i class="fa fa-credit-card"></i><?php echo __('Заказ'); ?> <span
                            class="label label-primary">№ <?php echo $obj->id; ?></span> <a
                            href="/wezom/<?php echo Core\Route::controller(); ?>/print/<?php echo $obj->id; ?>"
                            target="_blank"><?php echo __('Распечатать'); ?></a></div>
            </div>
            <div class="widgetContent">
                <div class="widget box">
                    <div class="widgetHeader">
                        <div class="widgetTitle"><i class="fa fa-clock-o"></i><?php echo __('Статус'); ?></div>
                    </div>
                ...
                <div class="widget box">
                    <div class="widgetHeader">
                        <div class="widgetTitle"><i class="fa fa-user"></i><?php echo __('Заказ на имя'); ?></div>
                    </div>
    ...
    <div class="col-md-5">
                ...
                <div class="widgetHeader">
                    <div class="widgetTitle">
                        ...
                        <?php if ($user->name || $user->last_name || $user->middle_name): ?>
                            <a href="<?php echo \Core\HTML::link('wezom/users/edit/' . $user->id); ?>"
                               class="label label-primary"
                               target="_blank"><?php echo $user->last_name . ' ' . $user->name . ' ' . $user->middle_name; ?></a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="widgetContent">
                        ...
                        <div class="widgetContent no-padding">
                            <div class="pageInfo alert alert-info">
                                <?php if ($user->phone): ?>
                                    <div class="rowSection">
                                        <div class="col-md-6"><strong><i
                                                        class="fa fa-envelope"></i> <?php echo __('Номер телефона'); ?>
                                            </strong></div>
                                        <div class="col-md-6"><a
                                                    href="tel:<?php echo preg_replace('/[^0-9]*/', '', $user->phone); ?>"><?php echo $user->phone; ?></a>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if ($user->email): ?>
                                    <div class="rowSection">
                                        <div class="col-md-6"><strong><i
                                                        class="fa fa-envelope"></i> <?php echo __('E-Mail'); ?></strong>
                                        </div>
                                        <div class="col-md-6"><a
                                ...
                                <?php if ($user->created_at): ?>
                                    <div class="rowSection">
                                        <div class="col-md-6"><strong><i
                                                        class="fa fa-calendar"></i> <?php echo __('Аккаунт зарегистрирован'); ?>
                                            </strong></div>
                                ...
                                <div class="rowSection">
                                    <div class="col-md-6"><strong><i
                                                    class="fa fa-tags"></i> <?php echo __('Выполненых заказов'); ?>
                                        </strong></div>
                                    <div class="col-md-6">
                                ...
                                <div class="rowSection">
                                    <div class="col-md-6"><strong><i
                                                    class="fa fa-tags"></i> <?php echo __('Количество товаров в выполненых заказах'); ?>
                                        </strong></div>
                                    <div class="col-md-6">
                                ...
                                <div class="rowSection">
                                    <div class="col-md-6"><strong><i
                                                    class="fa fa-money"></i> <?php echo __('Сумма выполненых заказов'); ?>
                                        </strong></div>
                                    <div class="col-md-6">
        ...
        <div class="widget box">
            <div class="widgetHeader">
                <div class="widgetTitle"><i class="fa fa-clock-o"></i><?php echo __('Доставка'); ?></div>
            </div>
...
<div class="rowSection">
    <div class="col-md-12">
        <div class="widget box">
            <div class="widgetHeader">
                <div class="widgetTitle"><i class="fa fa-shopping-cart"></i><?php echo __('Позиции'); ?> <span
                            class="label label-primary" id="orderPositionsCount"><?php echo sizeof($cart); ?></span>
                </div>
            </div>
            <div class="widgetContent">
                        ...
                        <tr data-order-item-id="<?php echo $item->order_item_id; ?>">
                            <td class="hidden-xs">
                                <?php if (is_file(HOST . Core\HTML::media('images/catalog/small/' . $item->image, false))): ?>
                                    <a href="/wezom/items/edit/<?php echo $item->id; ?>"
                                       class="tableOrderItemsThumb imageThumb" target="_blank">
                            ...
                            <td>
                                <div class="tableOrderItemsCost middle"><?php echo Price::getCurrencies($obj->currencies, $item->price); ?></div>
                                <div class="tableOrderItemsType middle"><?php echo Price::getCurrency($obj->currencies); ?></div>
                            </td>
                            <td>
                            ...
                            <td class="nav-column">
                                <ul class="table-controls">
                                    <li>
                                        <a class="bs-tooltip dropdownToggle liTipLink" href="javascript:void(0);"
                                           title="<?php echo __('Управление'); ?>"><i class="fa fa-cog size14"></i></a>
                                        <ul class="dropdownMenu pull-right">
                                            <li>
                                                <a title="<?php echo __('Редактировать товар'); ?>"
                                                   href="/wezom/items/edit/<?php echo $item->id; ?>" target="_blank"><i
                                                            class="fa fa-pencil"></i> <?php echo __('Редактировать товар'); ?>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="<?php echo __('Посмотреть товар'); ?>"
                                                   href="<?php echo \Core\HTML::link($item->alias . '/p' . $item->id); ?>"
                                                   target="_blank"><i
                                                            class="fa fa-fixed-width">&#xf06e;</i> <?php echo __('Посмотреть товар'); ?>
                                                </a></li>
                                            <li class="divider"></li>
                                            <li><a href="#" title="<?php echo __('Удалить позицию'); ?>"
                                                   class="orderPositionDelete"><i
                                                            class="fa fa-trash-o text-danger"></i> <?php echo __('Удалить позицию'); ?>
                                                </a></li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <div class="rowSection">
                    <div class="table-footer clearFix">
                        <div class="col-md-12 textright">
                            <button class="btn btn-info <?php echo !$obj->changed ? 'hide' : null; ?>" type="button"
                                    id="sendEmail"><?php echo __('Отправить уведомление об изменении заказа'); ?></button>
                            <button class="btn btn-default" type="button"
                                    href="/wezom/orders/add_position/<?php echo $obj->id; ?>"><?php echo __('Добавить товар'); ?></button>
                            <button class="btn btn-primary" type="button"
                                    id="orderItems"><?php echo __('Сохранить'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="widgetContent no-padding">
                <table class="table table-hover ">
                    ...
                    <tr>
                        ...
                        <td align="right" id="orderAmount"><span><?php echo Price::getCurrencies($obj->currencies, $amount); ?></span> <?php echo Price::getCurrency($obj->currencies); ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
