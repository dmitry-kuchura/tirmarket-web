...
<?php if (count($result)): ?>
    <div class="_lg-show">
        <div class="title _mb-3"><?php echo __('Просмотренные товары'); ?></div>
                ...
                <div class="_col-12 _sm-col-6 _lg-col-3 _mb-3">
                    <div class="item-card">
                        ...
                        <div class="_flex _justify-between _items-center _grid-space-3 _flex-nowrap">
                            ...
                            <span>
                                <i><svg><use xlink:href="<?php echo HTML::media('icons/icons.svg#cart'); ?>"></use></svg> </i>
