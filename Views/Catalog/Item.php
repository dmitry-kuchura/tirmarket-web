    ...
    <div class="_col-12 _lg-col-7 _xl-col-5 _flex-grow-0 _flex-shrink-0 _mb-3">
        ...
        <div class="product-meta _mb-4">
            ...
            <div class="_flex _items-center">
                <div class="_col-6">
                    <div class="product-maker"><?php echo __('Производитель'); ?>: <a href="#">LiquiMoly</a>
                </div>
            </div>
            <div class="_col-6">
                <a href="#" class="favorite-button" data-product="<?php echo $obj->id; ?>" data-user="<?php echo User::info()->id; ?>">
                                ...
                                <span>
                                    <i>
                                        <svg><use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                  xlink:href="icons/icons.svg#cart"></use></svg>
                                    </i>
                                    <span>В корзину</span>
                                </span>
                        </a>
