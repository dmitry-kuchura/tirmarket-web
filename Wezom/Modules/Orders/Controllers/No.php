...
use Wezom\Modules\Orders\Models\No AS Model;
use Wezom\Modules\Catalog\Models\Items;

class No extends \Wezom\Modules\Base
{

    public $tpl_folder = 'Orders/Empty';
    public $page;
    public $limit;
    public $offset;
    ...
    {
        parent::before();
        $this->_seo['h1'] = __('Заказы отсутствующих товаров');
        $this->_seo['title'] = __('Заказы отсутствующих товаров');
        $this->setBreadcrumbs(__('Заказы отсутствующих товаров'), 'wezom/' . Route::controller() . '/index');
